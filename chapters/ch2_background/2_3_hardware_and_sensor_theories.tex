...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{path_to_your_esp32_image.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{path_to_your_imu_image.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{path_to_your_camera_module_image.png}
