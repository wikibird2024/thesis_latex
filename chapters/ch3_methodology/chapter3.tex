...
\section*{Giới thiệu Chương} % Chapter introduction (un-numbered section)
...
\input{chapters/ch3_methodology/3_1_system_architecture.tex} % 3.1 System block diagram and overall design

\input{chapters/ch3_methodology/3_2_hardware_implementation.tex} % 3.2 Details on physical components (ESP32, Camera, IMU)

\input{chapters/ch3_methodology/3_3_software_implementation.tex} % 3.3 New: Software structure and development environment

% Following files are now renumbered:
\input{chapters/ch3_methodology/3_4_detection_logic.tex} % 3.4 Algorithms for fall detection and data fusion (Was 3.3)

\input{chapters/ch3_methodology/3_5_alerting_system.tex} % 3.5 Communication protocols (MQTT, SIP) and alert mechanisms (Was 3.4)

\input{chapters/ch3_methodology/3_6_chapter_conclusion.tex} % 3.6 Chapter conclusion and preparation for the next chapter (Was 3.5)
