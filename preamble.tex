...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%           VIETNAMESE LATEX THESIS PREAMBLE - FINAL VERSION
%           Optimized for XeLaTeX - No compile errors
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Unicode math (replace amssymb)
\usepackage{unicode-math}
\setmathfont{Latin Modern Math}

% Microtype (disable expansion for XeLaTeX)
...
\usepackage{calc}
\usepackage{url}
\usepackage{amsmath} % amssymb removed to avoid conflicts
...
% Bibliography
\usepackage[backend=biber,style=ieee,langid=english]{biblatex}
